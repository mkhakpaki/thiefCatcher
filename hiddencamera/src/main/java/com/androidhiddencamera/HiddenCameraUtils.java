...
public final class HiddenCameraUtils {
     ...
     * @param fileToSave file where encrypted file should stored
     * @param  password password that used with encryption function
     */
    static void saveFileEncrypted(@NonNull byte[] bytes,
                                  @NonNull File fileToSave,
                                  @NonNull String password){
        Encryption enc = new Encryption();
        HashMap<String, byte[]> encrypted = enc.encrypt(bytes,password.toCharArray());
